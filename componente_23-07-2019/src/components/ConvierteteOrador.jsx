...
class ConvierteteOrador extends React.Component{
    render(){
        return(
                        ...
                        <form>
                            ...
                            <div className="form-row">
                                <div className="form-group col">
                                    <textarea name="text" className="form-control form-control-lg" placeholder="Sobre qué quieres hablar" />
...
export default ConvierteteOrador;